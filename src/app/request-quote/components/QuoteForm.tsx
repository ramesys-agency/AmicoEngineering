    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      {showErrorModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl max-w-md w-full overflow-hidden border border-slate-200 dark:border-slate-700 animate-in zoom-in-95 duration-300">
            <div className="p-6">
              <div className="size-14 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center text-red-600 dark:text-red-400 mx-auto mb-4">
                <span className="material-symbols-outlined text-3xl">error_outline</span>
              </div>
              <h3 className="text-xl font-bold text-slate-900 dark:text-white text-center mb-3">Request Failed</h3>
              <p className="text-slate-600 dark:text-slate-400 text-center text-sm mb-6">{errorMessage}</p>
              <button
                onClick={() => {
        ...
        <div className="p-8 md:p-10">
          {status === "success" ? (
            <div className="py-12 text-center animate-in zoom-in duration-500">
              ...
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Quote Request Submitted!</h3>
              ...
              <button
                ...
                className="px-8 py-3 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <label className="block">
                      <span className="text-sm font-semibold text-slate-700 dark:text-slate-300 block mb-1.5">Full Name *</span>
                      <input
                        required
                        name="name"
                        value={formData.name}
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <label className="block">
                      <span className="text-sm font-semibold text-slate-700 dark:text-slate-300 block mb-1.5">Select Category *</span>
                      <select
                        required
                        name="category"
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-700 flex flex-col sm:flex-row items-center justify-between gap-6">
