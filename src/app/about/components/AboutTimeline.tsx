  ...
  return (
    <section className="py-20 bg-white  relative overflow-hidden">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-10 relative z-10">
        ...
        <div className="relative border-l-2 border-slate-200  ml-4 md:ml-1/2 md:-translate-x-[1px]">
          {/* Item 1 */}
          <div className="mb-12 flex flex-col md:flex-row items-start relative pl-12 md:pl-0">
            <div className="absolute left-[-9px] md:left-1/2 md:-ml-[9px] w-[20px] h-[20px] rounded-full bg-primary border-4 border-white  z-20"></div>
            <div className="md:w-1/2 md:pl-12 md:ml-auto">
              <div className="bg-background-light  p-6 rounded border border-slate-100  shadow-sm relative md:before:absolute md:before:top-6 md:before:-left-3 md:before:w-0 md:before:h-0 md:before:border-y-8 md:before:border-y-transparent md:before:border-r-8 md:before:border-r-background-light ">
          ...
          {/* Item 2 */}
          <div className="mb-12 flex flex-col md:flex-row items-start relative pl-12 md:pl-0">
            <div className="absolute left-[-9px] md:left-1/2 md:-ml-[9px] w-[20px] h-[20px] rounded-full bg-white  border-4 border-slate-300  z-20"></div>
            <div className="md:w-1/2 md:pr-12 md:mr-auto md:text-right">
              <div className="bg-background-light  p-6 rounded border border-slate-100  shadow-sm relative md:text-right text-left md:after:absolute md:after:top-6 md:after:-right-3 md:after:w-0 md:after:h-0 md:after:border-y-8 md:after:border-y-transparent md:after:border-l-8 md:after:border-l-background-light ">
                <span className="text-primary font-bold text-xl block mb-2">
                  2000s
                </span>
                <h4 className="text-lg font-bold text-slate-900  mb-2">
