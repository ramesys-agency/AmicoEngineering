      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        {categories.map((category) => (
          <div
            key={category.id}
            id={category.id}
            className="group flex flex-col bg-white  rounded-lg border border-slate-200  overflow-hidden hover:shadow-xl transition-all duration-300 h-full"
          >
            ...
            <div className="p-6 grow flex flex-col">
              <h3 className="text-slate-900  text-xl font-extrabold mb-3 group-hover:text-primary transition-colors">
                {category.name}
              </h3>
        ...
        <div className="flex flex-col bg-primary/5  rounded-lg border-2 border-dashed border-primary/30 items-center justify-center p-8 text-center h-full">
