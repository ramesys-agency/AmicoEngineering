  ...
  return (
    <div className="mt-16 flex justify-center">
      <nav className="flex items-center gap-3">
        <button
          disabled
          className="w-11 h-11 rounded-lg border border-slate-200 hover:bg-slate-100 dark:border-slate-700 dark:hover:bg-slate-800 transition-colors flex items-center justify-center group disabled:opacity-50"
        >
