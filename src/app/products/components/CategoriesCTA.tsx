  ...
  return (
    <div className="w-full bg-slate-50  border-t border-slate-200  mt-10">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-10 py-16 flex flex-col items-center text-center">
        ...
        <h2 className="text-slate-900  text-3xl font-bold leading-tight mb-3">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <button className="flex items-center justify-center rounded h-12 px-8 bg-white  border border-slate-300  text-slate-700  hover:bg-slate-50  text-base font-bold transition-colors">
            Download Catalog
          </button>
        </div>
      </div>
