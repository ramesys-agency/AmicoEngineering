    ...
    <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <select className="rounded-lg border-slate-200 text-sm font-medium py-2.5 pl-3 pr-10 focus:ring-primary focus:border-primary cursor-pointer bg-white    shadow-sm">
