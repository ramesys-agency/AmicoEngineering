    ...
    <div className="lg:col-span-4 flex flex-col gap-8">
      <div>
        ...
        <div className="grid gap-3">
          <div className="group flex items-center gap-4 p-3 rounded border border-slate-200  bg-white  hover:border-primary transition-all cursor-pointer">
            <div className="size-12 rounded bg-slate-100  flex items-center justify-center text-primary">
              <span className="material-symbols-outlined">oil_barrel</span>
            </div>
            <div>
              <h4 className="text-sm font-bold text-slate-900  group-hover:text-primary">
                Offshore Operations
              </h4>
