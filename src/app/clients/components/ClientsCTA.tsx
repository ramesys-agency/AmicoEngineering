    ...
    <section className="relative py-20 px-4 md:px-10 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[960px] mx-auto text-center flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
          <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded h-12 px-8 bg-primary hover:bg-primary/90 text-white font-bold transition-all shadow-lg hover:shadow-primary/50">
            Get a Quote
          </button>
          <button className="flex min-w-[200px] cursor-pointer items-center justify-center rounded h-12 px-8 bg-transparent border border-primary hover:bg-primary/10 text-primary font-bold transition-all">
            Contact Sales
          </button>
        </div>
      </div>
